...
export default function UserCreateEditForm({ onSave, onEdit, onClose, userId }) {
    const [user, setUser] = useState({});

    useEffect(() => {
        if (!userId) return;

        userService.getOneUser(userId).then(res => setUser(res));
        ...
        <div className="overlay">
            ...
            <div className="modal">
                <div className="user-container">
                    ...
                    <form onSubmit={userId ? onEdit : onSave}>
                        ...
                        <div id="form-actions">
                            <button id="action-save" className="btn" type="submit">{userId ? "Update" : "Save"}</button>
